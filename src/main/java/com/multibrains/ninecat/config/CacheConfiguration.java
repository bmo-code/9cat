package com.multibrains.ninecat.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(com.multibrains.ninecat.domain.User.class.getName(), jcacheConfiguration);
            ...
            cm.createCache(com.multibrains.ninecat.domain.Profile.class.getName(), jcacheConfiguration);
            cm.createCache(com.multibrains.ninecat.domain.Profile.class.getName() + ".posts", jcacheConfiguration);
